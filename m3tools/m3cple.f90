...
'Program M3CPLE to read all variables in each time step in the specified',  &
'time step sequence from the specified input file, optionally under the',   &
'control of the specified synchronization file, copy or interpolate them',  &
'to the output grid, and write them to the specified output file.',         &
'',                                                                         &
'THE PROGRAM WILL PROMPT YOU for the logical names of the input data file,',&
'the input synch file, and the output file, the time step sequence, and',   &
'the GRIDDESC name of the output grid.',                                    &
'',                                                                         &
'Default responses are indicated in square brackets [LIKE THIS], and',      &
'may be accepted by hitting the RETURN key.',                               &
'',                                                                         &
