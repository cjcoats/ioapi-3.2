#
#.........................................................................
# Version "$Id: Makefile.nocpl.sed 280 2025-04-12 15:34:39Z coats $"
...
#.........................................................................
#   Makefile-template for No-Couple version of M3Tools
...
FFLAGS = -I$(IODIR) ${MODI}$(OBJDIR) IOAPI_DEFS $(ARCHFLAGS) $(PARFLAGS) $(FOPTFLAGS) $(ARCHFLAGS)
...
#
 LIBS = -L${OBJDIR} -lioapi -lnetcdff -L/opt/lib -lnetcdf  \
 -L/usr/lib64 -lhdf5_hl -lhdf5 -Bdynamic -lm -lz -lzip -lbz2 -lzstd -lxml2 -lcurl \
...
GDLIB = -L/usr/lib64 -lgd -Bdynamic -lfontconfig -lfreetype -lxml2 -lexpat -lpng -lz -lbz2 -ljpeg -lm -lc
...
gregdate.f90    gisplot.f90     gistogis.f90    gistom3.f90     \
gridprobe.f90   insertgrid.f90  jul2greg.f90    juldate.f90     \
juldiff.f90     julshift.f90    kfxtract.f90    latlon.f90      \
llxy.f90        m3agmask.f90    m3agmax.f90     m3combo.f90     \
m3cple.f90      m3diff.f90      m3edhdr.f90     m3fake.f90      \
m3hdr.f90       m3interp.f90    m3mask.f90      m3merge.f90     \
m3pair.f90      m3plot.f90      m3probe.f90     m3stat.f90      \
m3togis.f90     m3totxt.f90     m3tproc.f90     m3tshift.f90    \
m3wndw.f90      m3xtract.f90    mpasdiff.f90    mpasstat.f90    \
mpastom3.f90    mtxblend.f90    mtxbuild.f90    mtxcalc.f90     \
mtxcple.f90     pairstep.f90    presterp.f90    presz.f90       \
projtool.f90    randomstat.f90  selmrg2d.f90    statbdry.f90    \
statcust.f90    statgrid.f90    statiddat.f90   statspars.f90   \
timediff.f90    timeshift.f90   vertimeproc.f90 vertintegral.f90 \
vertot.f90      wndwdesc.f90    wrfgriddesc.f90 wrftom3.f90

OBJ = $(f90SRC:.f90=.o) $(CmSRC:.f90=.o)

EXE = \
airs2m3         bcwndw          camxtom3        datshift        dayagg          \
factor          findwndw        gistogis        gistom3         gisplot         \
greg2jul        gregdate        gridprobe       insertgrid      jul2greg        \
juldate         juldiff         julshift        kfxtract        latlon          \
m3agmax         m3agmask        m3cple          m3combo         m3diff          \
m3edhdr         m3fake          m3hdr           m3interp        m3mask          \
m3merge         m3pair          m3plot          m3probe         m3stat          \
m3totxt         m3tproc         m3tshift        m3wndw          m3xtract        \
mtxblend        mtxbuild        mtxcalc         mtxcple         mpasdiff        \
mpasstat        mpastom3        presterp        presz           projtool        \
selmrg2d        timediff        timeshift       vertot          vertimeproc     \
vertintegral    wndwdesc        wrfgriddesc     wrftom3         randomstat
...
dayagg.o        : m3utilio.mod
diffstep.o      : m3utilio.mod
gistom3.o       : m3utilio.mod  modgisio.mod
gistogis.o      : m3utilio.mod  modgisio.mod
gisplot.o       : m3utilio.mod  modgisio.mod
gridprobe.o     : m3utilio.mod  modgctp.mod
insertgrid.o    : m3utilio.mod  modgctp.mod
latlon.o        : m3utilio.mod  modgctp.mod
llxy.o          : m3utilio.mod  modgctp.mod
...
m3plot.o        : m3utilio.mod  modgctp.mod
...
gisplot:  gisplot.o gdplot.o llxy.o
	cd ${OBJDIR}; ${FC} ${LFLAGS} $^ ${LIBS} ${GDLIB} -o $@
...
m3plot: m3plot.o gdplot.o llxy.o
	cd ${OBJDIR}; ${FC} ${LFLAGS}  $^ ${LIBS} ${GDLIB} -o $@
