...
get_endian.c getdfilec.c  getdttime.c  getefilec.c  gisio.c      hhmmssc.c    \
init3c.c     inqatt3c.c   interp3c.c   iobin3.c     julianc.c    locatsc.c    \
...
name2fid.f90    opnlist3.f90    pcoef.f90       pgrdsum.f90     pmatvec.f90     \
poly.f90        promptdfile.f90 promptffile.f90 promptgrid.f90  promptmfile.f90 \
rdbndary.f90    rdbuf3.f90      rdcustom.f90    rddict3.f90     rdgrdded.f90    \
rdiddata.f90    rdsmatrx.f90    readsmet.f90    realist.f90     runspec.f90     \
scanint.f90     sec2time.f90    setsphere.f90   skipl.f90       smatvec.f90     \
splitline.f90   str2dble.f90    str2int.f90     str2real.f90    strlist.f90     \
sync3.f90       synchtao.f90    time2sec.f90    trimlen.f90     ungridb.f90     \
ungridi.f90     upcase.f90      utm2ll.f90      wrbndary.f90    wrbuf3.f90      \
wrcustom.f90    wrdict3.f90     wrgrdded.f90    wriddata.f90    wrsmatrx.f90    \
xtbuf3.f90      xtract3.f90     year4.f90       permuti.f90
...
kfwrite.F90     m3exit.F90      m3msg2.F90      mmddyy.F90      nextime.F90     \
open3.F90       opnfil3.F90     opnkf.F90       opnlog3.F90     pn_crtfil3.F90  \
pn_opnfil3.F90  pn_wrvars.F90   rdatt3.F90      rdgrnest.F90    rdprofil.F90    \
rdtflag.F90     rdvars.F90      read3.F90       read4d.F90      secsdiff.F90    \
shut3.F90       single_thread.F90               syncfid.F90     updtvir3.F90    \
wkday.F90       wratt3.F90      wrgrnest.F90    write3.F90      write4d.F90     \
wrmpigrd.F90    wrpatch.F90     wrprofil.F90    wrtflag.F90     wrvars.F90      \
yr2day.F90

##  Module sources:

m90SRC = m3utilio.f90   modgctp.f90     modgisio.f90   modwrfio.f90    modmpasfio.f90
...
modgisio.o   modgisio.mod  :  m3utilio.mod
modmpasfio.o modmpasfio.mod:  m3utilio.mod modncfio.mod
