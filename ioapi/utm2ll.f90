...
SUBROUTINE UTM2LL( X, Y, Z, LON, LAT )
    ...
    !
    !  FUNCTION:
    !     Convert UTM zone-Z coordinates X-Y to LAT-LON coords
    !
    ...
    !***********************************************************************
    !   begin body of subroutine  UTM2LL()
