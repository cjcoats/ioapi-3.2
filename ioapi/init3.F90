...
#define  FLUSH flush_
    ...
    CHARACTER *80 NCFVER
    CHARACTER *80 PNCVER
    CHARACTER *80, PARAMETER :: IOAPILIBVER = 'ioapi-4.0: $Id: init3.F90 279 2025-04-15 15:33:31Z coats $'
...
!$OMP   END CRITICAL( S_NC )
    ...
    VERSN3 = IOAPILIBVER
    WRITE( VARVER, '( A, I5 )' ) 'Version 4.0.3 with PARMS3.EXT/PARAMETER::MXVARS3=', MXVARS3
