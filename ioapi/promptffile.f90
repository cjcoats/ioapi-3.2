...
INTEGER FUNCTION PROMPTFFILE( PROMPT, RDONLY, FMTTED, DEFAULT, CALLER )
    ...
    !***********************************************************************
    ! Version "$Id: promptffile.f90 203 2021-10-14 18:02:11Z coats $"
    ...
    !
    !       Prompts user for logical file name, then opens the Fortran file
    !       associated with it, for read-only or not, and formatted or not,
    !       as indicated by RDONLY and FMTTED
    !
    !  RETURNS:
    ...
    !       Revised  10/95 by CJC:  more robust treatment of 'NONE'
    !       Modified  8/96 by CJC:  ! is a comment-designator for input
    !       Modified  4/99 by CJC & M. Houyoux:  turn on/off prompting with
    !       environment variable "PROMPTFLAG"
    ...
    !***********************************************************************
    !   begin body of function  PROMPTFFILE
