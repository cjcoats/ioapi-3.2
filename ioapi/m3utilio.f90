...
MODULE M3UTILIO
    ...
    INTERFACE ENVGET
        ...
        REAL*8 FUNCTION BENVDBLE( LNAME, DESC, LO, HI, DEFAULT, STAT )
        ...
        INTEGER FUNCTION BENVINT( LNAME, DESC, LO, HI, DEFAULT, STAT )
            CHARACTER*(*), INTENT(IN   ) :: LNAME
            CHARACTER*(*), INTENT(IN   ) :: DESC
        ...
        INTEGER FUNCTION BENVINT8( LNAME, DESC, LO, HI, DEFAULT, STAT )
            CHARACTER*(*), INTENT(IN   ) :: LNAME
            CHARACTER*(*), INTENT(IN   ) :: DESC
        ...
        REAL FUNCTION BENVREAL( LNAME, DESC, LO, HI, DEFAULT, STAT )
            CHARACTER*(*), INTENT(IN   ) :: LNAME
            CHARACTER*(*), INTENT(IN   ) :: DESC
            REAL         , INTENT(IN   ) :: LO
            REAL         , INTENT(IN   ) :: HI
    ...
    INTERFACE FINDKEY
        ...
        INTEGER(8) FUNCTION FINDL3( K1, K2, K3, N, LIST1, LIST2, LIST3 )
            INTEGER(8), INTENT(IN   ) :: K1             !  first  key
            INTEGER(8), INTENT(IN   ) :: K2             !  second key
        ...
        INTEGER(8) FUNCTION FINDL4( K1, K2, K3, K4, N, LIST1, LIST2, LIST3, LIST4 )
            INTEGER(8), INTENT(IN   ) :: K1             !  first  key
            INTEGER(8), INTENT(IN   ) :: K2             !  second key
            INTEGER(8), INTENT(IN   ) :: K3             !  third  key
        ...
        INTEGER FUNCTION FINDR4( K1, K2, K3, K4, N, LIST1, LIST2, LIST3, LIST4 )
            REAL   , INTENT(IN   ) :: K1             !  first  key
            REAL   , INTENT(IN   ) :: K2             !  second key
            REAL   , INTENT(IN   ) :: K3             !  third  key
    ...
    INTERFACE
        INTEGER FUNCTION GETFFILE( LNAME, RDONLY, FMTFLAG, RECLEN, CALLER )
            CHARACTER*(*), INTENT(IN   ) :: LNAME          !  logical file name
            LOGICAL      , INTENT(IN   ) :: RDONLY         !  TRUE iff file is input-only
            LOGICAL      , INTENT(IN   ) :: FMTFLAG        !  TRUE iff file should be formatted
    ...
    INTERFACE LOCATE
        ...
        INTEGER(8) FUNCTION LOCATL3( K1, K2, K3, N, LIST1, LIST2, LIST3 )
            INTEGER(8), INTENT(IN   ) :: K1             !  first  key
            INTEGER(8), INTENT(IN   ) :: K2             !  second key
            INTEGER(8), INTENT(IN   ) :: K3             !  third  key
            INTEGER   , INTENT(IN   ) :: N              !  table size
        ...
        INTEGER(8) FUNCTION LOCATL4( K1, K2, K3, K4, N, LIST1, LIST2, LIST3, LIST4 )
            INTEGER(8), INTENT(IN   ) :: K1             !  first  key
            INTEGER(8), INTENT(IN   ) :: K2             !  second key
            INTEGER(8), INTENT(IN   ) :: K3             !  third  key
        ...
        INTEGER FUNCTION LOCATR4( K1, K2, K3, K4, N, LIST1, LIST2, LIST3, LIST4 )
            REAL   , INTENT(IN   ) :: K1             !  first  key
            REAL   , INTENT(IN   ) :: K2             !  second key
            REAL   , INTENT(IN   ) :: K3             !  third  key
    ...
    INTERFACE
        SUBROUTINE RUNSPEC( FNAME, USEENV, SDATE, STIME, TSTEP, NRECS )
            ...
            LOGICAL,          INTENT(IN   ) :: USEENV       !!  use env vbles for SDATE etc...?
