...
INTEGER FUNCTION LOCATC( K1, N, LIST1 )
    ...
    !***********************************************************************
    ! Version "$Id: locatc.f90 203 2021-10-14 18:02:11Z coats $"
    ...
    !
    !  RETURNS:
    !       subscript at which the targeted CHARACTER-STRING key should
    !       be inserted, or -1 if the key is found.
